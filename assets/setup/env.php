...
if (!defined('DB_DATABASE'))                    define('DB_DATABASE', 'wrqtepbzfx');
if (!defined('DB_HOST'))                        define('DB_HOST','localhost');
if (!defined('DB_USERNAME'))                    define('DB_USERNAME','wrqtepbzfx');
if (!defined('DB_PASSWORD'))                    define('DB_PASSWORD' ,'J26RqgPKfq');
if (!defined('DB_PORT'))                        define('DB_PORT' ,'');

if (!defined('MAIL_HOST'))                      define('MAIL_HOST', 'smtp.gmail.com');
if (!defined('MAIL_USERNAME'))                  define('MAIL_USERNAME', 'sujoinhouse@gmail.com');
if (!defined('MAIL_PASSWORD'))                  define('MAIL_PASSWORD', 'sujoin@DEV');
